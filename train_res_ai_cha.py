...
def run(trainr,test_dr, name,cls_num,idx):
    ...
    model.fc1 = nn.Linear(2048, 10)
    model.fc2 = nn.Linear(10, cls_num)
    ...
    state['cls_name'] = name
    centerloss = CenterLoss(cls_num,10)
    centerloss.cuda()
...
if __name__ == '__main__':
    ...
    test_dr = '/media/dsl/20d6b919-92e1-4489-b2be-a092290668e4/AIChallenger2018/new/base_line_valid'
    run(train_dr,test_dr, 'luntai',61, 'ai_chan')