from model.native_pna import pnasnet5large
...
def run(trainr,testdr, name,cls_num,idx):
    ...
    test_data = ImageFolder(testdr,
                                transform=data_transforms['val'])
    data_loader = DataLoader(imagenet_data, batch_size=2, shuffle=True)
    test_data_loader = DataLoader(test_data, batch_size=1, shuffle=True)
    model = pnasnet5large(num_classes=1001, pretrained=None)
    model.load_state_dict(torch.load('/home/dsl/all_check/pnasnet5large-bf079911.pth'), strict=False)
    model.last_linear = nn.Linear(4320, cls_num)
...
if __name__ == '__main__':
    train_dr = '/media/dsl/20d6b919-92e1-4489-b2be-a092290668e4/dsl/train/step3/train'
    test_dr = '/media/dsl/20d6b919-92e1-4489-b2be-a092290668e4/dsl/valid/step2'
    run(train_dr, test_dr, 'luntai', 11, '1008_pna_norm_step3')